...
namespace HLTVnet.Parsing
{
    public static partial class HLTVParser
    {
        ...
        {
            return HLTVParser.FetchPage("results?offset=" + offset, ParseResultsPage, proxy);
        }
        ...
        private static List<MatchResult> ParseResultsPage(Task<HttpResponseMessage> response)
        {
            ...
            foreach (HtmlNode resultNode in resultConNodes)
            {
                ...
                model.Date = HLTVParser.DateTimeFromUnixTimestampMillis(unixDateMilliseconds);
